...
执行时间（UTC）：2026-09-26T07:10:11+00:00
...
| DOMAIN_SCHEMA | PASS | 64 Draft 2020-12 definitions; format checks enabled for fixtures |
| CONTRACT_REFERENCES | PASS | 106 JSON Schema/OpenAPI reference occurrences resolved offline |
| FIXTURE_SCHEMA | PASS | 27 positive objects accepted; 5 negative objects rejected |
| OPENAPI_STRUCTURAL | PASS | 24 operation IDs, local auth, path parameters, write headers and SSE example checked; structural checks, not a full OpenAPI conformance validator |
| MARKDOWN_LINKS | PASS | 223 relative Markdown link targets exist |
