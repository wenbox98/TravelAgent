...
执行时间（UTC）：2026-09-26T12:54:19+00:00
...
| DOMAIN_SCHEMA | PASS | 76 Draft 2020-12 definitions; format checks enabled for fixtures |
| CONTRACT_REFERENCES | PASS | 128 JSON Schema/OpenAPI reference occurrences resolved offline |
| FIXTURE_SCHEMA | PASS | 27 positive objects accepted; 5 negative objects rejected |
| OPENAPI_STRUCTURAL | PASS | 30 operation IDs, local auth, path parameters, write headers and SSE example checked; structural checks, not a full OpenAPI conformance validator |
| MARKDOWN_LINKS | PASS | 228 relative Markdown link targets exist |
