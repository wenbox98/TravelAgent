...
CONTEXT_REASONS = frozenset({"CONTEXT_REVIEW_REQUIRED", "WORK_CONTEXT_VERIFIED", "CONTEXT_UNCERTAIN",
    ...
    "DEPENDENCY_INDEPENDENT", "NOT_TRAVEL_EVIDENCE", "UNVERIFIED_IMPORTANT_FACT", "MODEL_CONTEXT_SUPPORTED",
    "INSUFFICIENT_CONTEXT", "INVALID_REFERENCE", "ROLE_MISMATCH", "DURATION_SCOPE_MISMATCH"})
